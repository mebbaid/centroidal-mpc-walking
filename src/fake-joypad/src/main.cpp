...
int main(int argc, char* argv[])
{
    ...
    rf.setDefaultConfigFile("centroidal_mpc_joypad.ini");
    ...
    auto fakeJoypad = std::make_unique<StableCentroidalMPCWalking::FakeJoypad>();
    ...
    auto joypadProvider = std::make_unique<StableCentroidalMPCWalking::JoypadProvider>();
    ...
    auto input0 = BipedalLocomotion::System::SharedResource<
        StableCentroidalMPCWalking::FakeJoypad::Input>::create();
    auto output0 = BipedalLocomotion::System::SharedResource<
        StableCentroidalMPCWalking::FakeJoypad::Output>::create();

    BipedalLocomotion::System::AdvanceableRunner<StableCentroidalMPCWalking::FakeJoypad> fakeJoypadRunner;
    ...
    BipedalLocomotion::System::AdvanceableRunner<StableCentroidalMPCWalking::JoypadProvider>
